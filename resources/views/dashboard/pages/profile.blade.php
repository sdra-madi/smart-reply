    ...
    <div class="div">
        <div class="w-full px-6 mx-auto">
            <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl"
                style="background-image: url('../portal/assets-pro/img/curved-images/curved0.jpg'); background-position-y: 50%;">
                <span
                            ...
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                <li
                                    ...
                                    <div
                                        ...
                                        <img src="../portal/assets-pro/img/kal-visuals-square.jpg" alt="kal"
                                ...
                                <li
                                    ...
                                    <div
                                        class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-base ease-soft-in-out rounded-xl">
                                        <img src="../portal/assets-pro/img/marie.jpg" alt="kal"
                                            class="w-full shadow-soft-2xl rounded-xl" />
                                    </div>
                                    <div class="flex flex-col items-start justify-center">
                                ...
                                <li
                                    ...
                                    <div
                                        class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-base ease-soft-in-out rounded-xl">
                                        <img src="../portal/assets-pro/img/ivana-square.jpg" alt="kal"
                                            class="w-full shadow-soft-2xl rounded-xl" />
                                    </div>
                                    <div class="flex flex-col items-start justify-center">
                                ...
                                <li
                                    ...
                                    <div
                                        class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-base ease-soft-in-out rounded-xl">
                                        <img src="../portal/assets-pro/img/team-4.jpg" alt="kal"
                                            class="w-full shadow-soft-2xl rounded-xl" />
                                    </div>
                                    <div class="flex flex-col items-start justify-center">
                                ...
                                <li
                                    ...
                                    <div
                                        class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-base ease-soft-in-out rounded-xl">
                                        <img src="../portal/assets-pro/img/team-3.jpg" alt="kal"
                                            class="w-full shadow-soft-2xl rounded-xl" />
                                    </div>
                                    <div class="flex flex-col items-start justify-center">
                            ...
                            <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div
                                        ...
                                        <div class="relative">
                                            <a class="block shadow-xl rounded-2xl">
                                                <img src="../portal/assets-pro/img/home-decor-1.jpg" alt="img-blur-shadow"
                                                ...
                                                <div class="mt-2">
                                                    <a href="javascript:;"
                                                        ...
                                                        <img class="w-full rounded-circle" alt="Image placeholder"
                                                            src="../portal/assets-pro/img/team-1.jpg" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-target="tooltip_trigger" data-placement="bottom">
                                                        <img class="w-full rounded-circle" alt="Image placeholder"
                                                            src="../portal/assets-pro/img/team-2.jpg" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip">
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-target="tooltip_trigger" data-placement="bottom">
                                                        <img class="w-full rounded-circle" alt="Image placeholder"
                                                            src="../portal/assets-pro/img/team-3.jpg" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip">
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        data-target="tooltip_trigger" data-placement="bottom">
                                                        <img class="w-full rounded-circle" alt="Image placeholder"
                                                            src="../portal/assets-pro/img/team-4.jpg" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip">
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a class="block shadow-xl rounded-2xl">
                                                <img src="../portal/assets-pro/img/home-decor-2.jpg" alt="img-blur-shadow"
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div
                                        ...
                                        <div class="relative">
                                            <a class="block shadow-xl rounded-2xl">
                                                <img src="../portal/assets-pro/img/home-decor-3.jpg" alt="img-blur-shadow"
                                                    class="max-w-full shadow-soft-2xl rounded-2xl" />
                                            </a>
                                        </div>
                                        <div class="flex-auto px-1 pt-6">
